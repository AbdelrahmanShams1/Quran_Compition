            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 p-4 rounded-lg space-y-2">
                <p className="flex items-center gap-2 transform transition-all duration-300 hover:translate-x-2">
                  ...
                  <span className="font-bold">30 نقطة:</span> الصلاة في المسجد مع الجماعة
                </p>
                <p className="flex items-center gap-2 transform transition-all duration-300 hover:translate-x-2">
                  <FaCheckCircle className="w-4 h-4 text-green-600" />
                  <span className="font-bold">15 نقطة:</span> الصلاة في الوقت (بدون جماعة)
                </p>
                <p className="flex items-center gap-2 transform transition-all duration-300 hover:translate-x-2">
                  <FaCheckCircle className="w-4 h-4 text-green-600" />
